...
class _RecettesEcranState extends State<RecettesEcran> {
  ...
  void _showRecetteDialog(BuildContext context, Map<String, dynamic> recette) {
    ...
    final temps = recette['temps'] as Map<String, dynamic>? ?? {};
          ...
          child: Column(
            ...
            children: [
              ...
              if (temps.isNotEmpty) ...[
                ...
                Text("Préparation : ${temps['preparation'] ?? '-'}"),
                Text("Cuisson : ${temps['cuisson'] ?? '-'}"),
                Text("Repos : ${temps['repos'] ?? '-'}"),
                Text("Total : ${temps['temps_total'] ?? '-'}"),
                const SizedBox(height: 10),
              ],
